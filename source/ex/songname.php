...
// sql to create table
$sql = "INSERT INTO songname (name,n0_hit,genre ,year,duration )
VALUES
('$_POST[name]','$_POST[year]','$_POST[genre]','$_POST[year]','$_POST[duration]')";
...
<form>
<input name="newThread" type="button" value="back" onclick="self.close();window.open('songnameform.php')"/>
</form>

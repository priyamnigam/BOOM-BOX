...
$sql = "UPDATE composerpopular  SETcrating=". "\"$_POST[crating]\" and rating=". "\"$_POST[rating]\" where name=". "\"$_POST[name]\"";
...
<br></br>
 ...
 <form>
<input name="newThread" type="button" value="back" onclick="self.close();window.open('composerspage.php')"/>
</form>
